...
ckptName = "/1556181121.6235015GrayScale_rate0.0003_epoch85_batch500.ckpt"
...
# ---------------------------------------------------------------------------------------------------
# X: input 48*48*image_depth
# Y: output 0 ~ 6
X = tf.placeholder(tf.float32, [None, 48 * 48 * image_depth])
...
# img 48x48x1 (GrayScale)
X_img = tf.reshape(X, [-1, 48, 48, image_depth])

# ---------------------------------------------------------------------------------------------------
# L1 ImgIn shape = (?, 48, 48, image_depth)
...
# Pool -> (?, 1, 1, 512)
L5 = tf.nn.max_pool(L5, ksize=[1, 3, 3, 1], strides=[1, 3, 3, 1], padding='SAME') ############################
